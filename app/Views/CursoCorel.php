<script src="<?= base_url()?>/resources/js/jsCorel.js"></script>
<script>
  ruta='<?= base_url()?>';  
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <div class="col-md-6">
                    <p class="text-xl-center"><a class="btn btn-lg btn-success" target="_blank" href="<?php echo base_url();?>/Portada/Corel"role="button">Dar Examen</a></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
           ...
           <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="hidden" class="form-control" id="idCur" value="12" 
