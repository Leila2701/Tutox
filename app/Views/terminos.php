<p><section class="container text-justify">
	<div >
		<div class="text-center">
			<b><h1 style="color: #468889; font-weight: bold;">TÉRMINOS Y CONDICIONES DE USO</h1></b>
		</div>

		<h3>
			<h3 style="color: #468889; font-weight: bold;">1. Aceptación</h3>
			<p>En el presente documento (en adelante, el “Contrato”) se establecen los términos y condiciones de TUTOX, página web para el uso de aprendizaje en distintos cursos basicos(el  “Sitio Web”). Les rogamos lean atentamente el presente Contrato. 
			...
			<h3 style="color: #468889; font-weight: bold;">2. Requisitos Relativos al Usuario</h3>

			<p>El Sitio Web y los servicios relacionados con el mismo se ofrecen a los Usuarios que tengan capacidad legal para otorgar contratos legalmente vinculantes según la legislación aplicable. 
			Los menores no están autorizados para utilizar el Sitio Web. Si usted es menor de edad, por favor, no utilice esta web. </p>

			<h3 style="color: #468889; font-weight: bold;">3. Licencia</h3>
			...
			(vi) satisfacer cualquier petición relativa a la infracción de derechos de terceros.</p>

			<h3 style="color: #468889; font-weight: bold;">5. Prohibición General</h3>
			
			<p>Al acceder a y utilizar el Sitio Web, el Usuario se compromete a NO:
			...
			(m) falsear los datos sobre sí mismo, sobre su asociación con terceros o sobre su empresa.</p>

			<h3 style="color: #468889; font-weight: bold;">6. Utilización del Sitio y Obligaciones Concretas</h3>

			<p>Además de las obligaciones generales señaladas en el Artículo 5, el Usuario deberá:
			...
			(e) asumir el riesgo de confiar en el contenido, o utilizar la información, facilitados por terceros.</p>

			<h3 style="color: #468889; font-weight: bold;">7. Cuenta y Contraseña</h3>
			
			<p>Cuando el Usuario utiliza el Sitio Web, puede optar por abrir una cuenta en el Sitio. En ese caso, el Usuario recibirá el número de cuenta virtual y la contraseña inicial que le correspondan. Es responsabilidad exclusiva del Usuario:
			...
			(c) notificar inmediatamente a RH, si tiene conocimiento del uso no autorizado de su cuenta o de cualquier vulneración de las medidas de seguridad.</p>

			<h3 style="color: #468889; font-weight: bold;">8. Empleo</h3>
			
			<p>El Usuario asume y acepta que RH:
			...
			(e) no es ni una empresa que contrata al Usuario ni existe contrato de agencia alguno. El Usuario deberá usar su buen juicio, precaución y sentido común a la hora de evaluar las empresas que puedan contratarle y la información facilitada por terceros.</p>

			<h3 style="color: #468889; font-weight: bold;">9. Vínculos a Páginas Web de Terceros</h3>
			
			<p>La inclusión de los Sitios Relacionados en el Sitio Web no implica que haya relación o asociación alguna entre RH y el propietario de los Sitios Relacionados, ni la aprobación o promoción por parte de RH de dichos Sitios Relacionados. RH incluye los Sitios Relacionados solamente para comodidad del Usuario. Este es el único responsable del acceso a los Sitios Relacionados. 
			...
			<h3 style="color: #468889; font-weight: bold;">11. Cookies</h3>
			...
			Las cookies no pueden transmitir virus y tampoco dañan su computadora.</p>

			<p style="font-weight: bold;">¿Qué cookies utilizamos?</p>

			<p>a. Cookies estrictamente necesarias:</p>

			<p>Son las cookies necesarias para  el correcto funcionamiento del sitio web y no se pueden borrarlas de nuestros servidores. Son generalmente activadas en respuesta a la solicitud de acciones  tales como definición de sus preferencias de privacidad, acceso (login)  o relleno de formularios. Usted puede configurar su navegador para bloquearlas o notificarle sobre ellas, pero algunos de los servicios disponibles en el sitio pueden dejar de estar operativos. Estas cookies no almacenan ninguna clase de información personal.</p>

			<p style="font-weight: bold;">¿Cómo se pueden desactivar las cookies?</p>

			<p>Se encuentran más informaciones sobre activar/desactivar  y eliminar las cookies en la política de privacidad del navegador instalado en su equipo  (vea las opciones  en el menú de ayuda disponible del navegador o consulte el sitio web de su proveedor).
			...
			Se encuentra más aclaraciones generales sobre las cookies en la siguiente página web: www.allaboutcookies.org</p>

			<h3 style="color: #468889; font-weight: bold;">12. Indemnización</h3>
			
			<p>El Usuario se compromete a indemnizar, defender en pleito y exonerar de toda responsabilidad a RH, a la empresa matriz y a las empresas subsidiarias y afiliadas de ésta, así como a los directivos, encargados, comerciales y empleados de todas ellas, frente a las reclamaciones de terceros (en la indemnización se incluyen, entre otros, los gastos de los abogados intervinientes y los costos judiciales) interpuestas con base en, o derivadas de, el acceso por parte del Usuario al Sitio Web y el uso que este haga del mismo, la Información facilitada por el Usuario, o el incumplimiento por parte de este de los términos y condiciones de este contrato.</p>
			<div class="text-center">
				<a class="btn btn-primary align-items-center" href="<?php echo base_url();?>/Portada/index"> ACEPTAR </a>
			</div>
