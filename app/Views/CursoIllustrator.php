<script src="<?= base_url()?>/resources/js/jsIllustrator.js"></script>
<script>
  ruta='<?= base_url()?>';  
...
<script>
  ...
  $(document).ready(function() {
    listarcomentario();
          ...
          <div>
            <img src="<?php echo base_url();?>/resources/img/illustrator-titulo.jpg" class="d-block w-100" alt="..." style="width: 100%">
          </div>
          <div id="reporte2">                   
          </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <div class="col-md-6">
                    <p class="text-xl-center"><a class="btn btn-lg btn-success" target="_blank" href="<?php echo base_url();?>/Portada/illustratorExamen"role="button">Dar Examen</a></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
           ...
           <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="hidden" class="form-control" id="idCur" value="10" 
