...
use App\Models\PhotoshopModelo;
class Photoshop extends BaseController
{
  ...
  {
    return view('headerRegistro').view('CursoPhotoshop').view('footer');
  }
  
  public function doList(){
    $cadena="";
    $respuesta=array();         
    $modelo = new PhotoshopModelo($db);   
    $lista=$modelo->listar();
