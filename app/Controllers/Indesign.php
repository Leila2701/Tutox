<?php namespace App\Controllers;
 ...
 use App\Models\IndesignModelo;
 class Indesign extends BaseController
 {
  ...
  {
    return view('headerRegistro').view('CursoInDesign').view('footer');
  }
  
  public function doList(){
    $cadena="";
    $respuesta=array();         
    $modelo = new IndesignModelo($db);   
    $lista=$modelo->listar();
