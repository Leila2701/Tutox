...
use App\Models\IllustratorModelo;
class Illustrator extends BaseController
{
  ...
  {
    return view('headerRegistro').view('CursoIllustrator').view('footer');
  }
  
  public function doList(){
    $cadena="";
    $respuesta=array();         
    $modelo = new IllustratorModelo($db);   
    $lista=$modelo->listar();
