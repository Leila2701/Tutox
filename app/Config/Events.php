...
Events::on('post_controller_constructor', function () {
	 ...
	 $class = strtoupper($router->controllerName()); //Class llamada
  	$method = strtoupper($router->methodName()); //metodo llamado
  		...
  		$nocontrolados = array('\APP\CONTROLLERS\PORTADA','\APP\CONTROLLERS\LOGIN','\APP\CONTROLLERS\ERRORACCESO','\APP\CONTROLLERS\CURSO','\APP\CONTROLLERS\REPORTE','\APP\CONTROLLERS\CNPERSONA');  
